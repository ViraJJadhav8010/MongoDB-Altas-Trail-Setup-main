...
app.get('/Dataownerlogin', (req, res) => {
    res.sendFile(path.join(__dirname, '/pages/Dataownerlogin.html'))
})

app.get('/DataownerRegistration', (req, res) => {
    res.sendFile(path.join(__dirname, '/pages/DataownerRegistration.html'))
})
